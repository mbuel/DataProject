...
public class HashTableTest {
    ...
    public void InsertCase(String insertString, boolean testResults, int testCaseNumber){
        System.out.println("HashTable Insert Test Case " + testCaseNumber + ": " + System.lineSeparator()
    ...
    public void LookupCase(String searchString, String compareString, boolean testResults, int testCaseNumber, String foundString){
        System.out.println("HashTable Lookup Test Case " + testCaseNumber + ": " + System.lineSeparator()
    ...
    public void DeleteCase(String searchString, boolean testResults, int testCaseNumber){
        System.out.println("HashTable Delete Test Case " + testCaseNumber + ": " + System.lineSeparator()
    ...
    public void HashTest()
    {
        ...
        testResults = HashTest.Insert(insertString);
        ...
        testResults = HashTest.Insert("Billy Kidd 555-235-1115 billy_the_kid@nowhere.com");
        InsertCase(insertString, testResults,testCase);
        testCase++;
        ...
        testStringResults = HashTest.Lookup(searchString);
        ...
        testResults = HashTest.Delete(searchString);
